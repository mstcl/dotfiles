...
let s:I1 = [ '#101010', '#78859e', s:term_black, s:term_blue ]
let s:I2 = s:N2
let s:I3 = [ '#78859e', '#101010', s:term_blue, '' ]
...
let s:R1 = [ '#101010', '#b67262', s:term_black, s:term_red ]
let s:R2 = s:N2
let s:R3 = [ '#b67262', '#101010', s:term_red, '' ]
...
let s:V1 = [ '#101010', '#a8d2db', s:term_black, s:term_purple ]
let s:V2 = s:N2
let s:V3 = [ '#a8d2db', '#101010', s:term_purple, '' ]
...
" Warnings
let s:WI = [ '#101010', '#c0a474', s:term_black, s:term_yellow ]
...
" Errors
let s:ER = [ '#101010', '#b67262', s:term_black, s:term_red ]
