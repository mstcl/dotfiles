...
let g:airline#themes#gotcha#palette.accents = {
    \ 'red': [ '#7c7c7c', '', s:term_red, 0 ]
        \ }

let s:N1 = [ '#101010', '#8e8e8e', s:term_black, s:term_green ]
let s:N2 = [ '#b9b9b9', '#151515', s:term_white, s:term_grey ]
let s:N3 = [ '#8e8e8e', '#101010', s:term_green, '' ]
...
let s:I1 = [ '#101010', '#686868', s:term_black, s:term_blue ]
let s:I2 = s:N2
let s:I3 = [ '#686868', '#101010', s:term_blue, '' ]
...
let s:R1 = [ '#101010', '#7c7c7c', s:term_black, s:term_red ]
let s:R2 = s:N2
let s:R3 = [ '#7c7c7c', '#101010', s:term_red, '' ]
...
let s:V1 = [ '#101010', '#868686', s:term_black, s:term_purple ]
let s:V2 = s:N2
let s:V3 = [ '#868686', '#101010', s:term_purple, '' ]
...
let s:IA1 = [ '#101010', '#b9b9b9', s:term_black, s:term_white ]
let s:IA2 = [ '#b9b9b9', '#151515', s:term_white, s:term_grey ]
let s:IA3 = s:N2
...
" Warnings
let s:WI = [ '#101010', '#a0a0a0', s:term_black, s:term_yellow ]
...
" Errors
let s:ER = [ '#101010', '#7c7c7c', s:term_black, s:term_red ]
