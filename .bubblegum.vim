...
let s:airline_a_visual = [ s:gui_orange , s:gui_red , s:cterm_orange , s:cterm_red ]
let s:airline_b_visual = ['s:gui_orange , s:gui_pink , s:cterm_orange , s:cterm_pink ]                                              
let s:airline_c_visual = [ s:gui_orange , s:gui_green , s:cterm_orange  , s:cterm_green ]                   
let g:airline#themes#bubblegum#palette.visual = airline#themes#generate_color_map(s:airline_a_visual, s:airline_b_visual, s:airline_c_visual)

let g:airline#themes#bubblegum#palette.visual_modified = {
    ......\ 'airline_c': [ s:gui_orange , s:gui_pink , s:cterm_orange , s:cterm_pink , '' ] ,
    ......\ }
