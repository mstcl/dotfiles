...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'gitsigns.nvim', 'nvim-lightbulb', 'nvim-lspconfig', 'nvim-ts-rainbow', 'cleanfold.nvim', 'foldsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
