...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lsp_signature.nvim', 'nvim-treesitter', 'cleanfold.nvim', 'gitsigns.nvim', 'nvim-lightbulb', 'foldsigns.nvim', 'nvim-lspconfig', 'nvim-ts-rainbow'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'ultisnips', 'nvim-compe', 'better-escape.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
