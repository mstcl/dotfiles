...
"---INDENTLINE---
let g:indentLine_fileTypeExclude = ['startify', 'nerdtree', 'NvimTree', 'man', 'Scratch', 'help', 'vimwiki']
...
let g:vimwiki_list = [{
    ...
    \'auto_tags':1,
    \'auto_toc':1,
    \'path_html': '$HOME/vimwiki/site_html/',
...
autocmd InsertEnter *.{vimwiki,wiki} set conceallevel=0
autocmd InsertLeave *.{vimwiki,wiki} set conceallevel=2
